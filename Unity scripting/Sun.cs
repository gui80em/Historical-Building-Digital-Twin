...
namespace Entropedia
{
    ...
    //indica que un objecte ha de tindre un component Light adjunt
    //a ell per funcionar
    [ExecuteInEditMode]
    //indica a unity que l'script ha d'executar-se

    //hereta monobehaviour per adjuntar la classe a un objecte de l'escena
    public class Sun : MonoBehaviour
    {
        //permet veure la variable des de l'inspector i modificar-la
        [SerializeField]
        float longitude;
        ...
        //inicialitza variables de l'script en funció dels components de l'objecte 
        //al que està unit i l'hora i data del sistema 
        private void Awake()
        {
        ...
        //aquest mètode s'actualitza automàticament quan es canvia el valor
        //per a un component des de l'editor. Actualitza el valor de les variables al codi.
        ...
        void SetPosition()
        {
            ...
            // MODIFICAR PARA OBTENER SEGUN TIEMPO
            light.intensity = Mathf.InverseLerp(-12, 0, angles.x);
            
            //Debug.Log("S'executa");
            //Debug.Log( Mathf.InverseLerp(-12, 0, angles.x));
        }
